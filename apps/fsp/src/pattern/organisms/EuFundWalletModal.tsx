...
const EnduserFundWalletFormModal = ({open, setOpen}: Props) => {
//   const [open, setOpen] = useState<boolean>(false);
  const [sent, setSent] = useState<boolean>(false);
  const [amount, setAmount] = useState<string>("");
  const [review, setReview] = useState<string>("");
  const [selected, setSelected] = useState("end-user wallet");
                    ...
                    <div className="bg-white text-sm">
                      ...
                      >
                        ...
                        <SelectContent className="text-sm z-[2000]">
                          <SelectScrollUp />
                          <SelectViewport>
                            <SelectItem value="end-user wallet">
                              <SelectItemText>End-user Wallet</SelectItemText>
                              <SelectItemIndicator />
                            </SelectItem>
                          </SelectViewport>
                          <SelectScrollDown />
        ...
        <CongratsModal isOpen={sent} setIsOpen={setSent}>
          <div className="">
            <p className="text-xs my-4 font-medium text-center">
              You have just sent &#8358;1,000,000 to Paystack.
            </p>
            <button
              onClick={() => {
                setSent(false);
...
export default EnduserFundWalletFormModal;
