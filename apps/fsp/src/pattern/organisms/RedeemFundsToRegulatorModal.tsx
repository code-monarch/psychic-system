...
import SelectRegulatorWalletType from "../molecules/SelectRegulatorWalletType";
...
const RedeemFundsToRegulatorModal = ({ open, setOpen }: Props) => {
      ...
      <Dialogue isopen={open} setisopen={setOpen} className="">
        <DialogueTrigger>
          <button className="flex items-center gap-2">
            <CbdcIcon color="#1e252d" /> Redeem Funds to Regulator
          </button>
        </DialogueTrigger>
              ...
              <div>
                <div className="flex justify-between items-baseline border rounded-lg border-[#8499b166] px-4 pb-4 mb-4">
                  <div className="flex-1">
                    <p className="font-semibold my-4">Regulator Wallet Type:</p>
                    <SelectRegulatorWalletType />
                  </div>
...
export default RedeemFundsToRegulatorModal;
