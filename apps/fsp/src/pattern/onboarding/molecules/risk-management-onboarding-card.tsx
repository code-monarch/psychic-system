...
import { RiskManagementOnboardingIcon } from "@emtech/icons";
...
const RiskManagementOnboardingCard: FC<IOnboardingCardProps> = ({
  title,
  htmlFor,
  color,
  textClass,
  ...
  return (
    <CardContainer htmlFor={`${htmlFor}`}>
      <CardIcon isSelected={isSelected}>
        <RiskManagementOnboardingIcon color={color} />
      </CardIcon>
...
export default RiskManagementOnboardingCard;
