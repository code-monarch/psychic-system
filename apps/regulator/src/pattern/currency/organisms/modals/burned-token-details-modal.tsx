...
const BurnedTokenDetailsModal: FC<IMintDetailsProps> = ({
  walletTo,
  amount,
  entity,
  date,
      ...
      <ModalCard
        title={
          <div className='flex items-center gap-x-[16px]'>
            <h3 className='text-[24px]'>Burn Details</h3>
            <PrinterIcon />
          </div>
        }
            ...
            <div className='w-full space-y-[36px]'>
              ...
              >
                ...
                <Flex className='w-full justify-between'>
                  ...
                  <h2 className={styles.value}>Reserve</h2>
                </Flex>
                {/* Destination End */}
...
export default BurnedTokenDetailsModal;
