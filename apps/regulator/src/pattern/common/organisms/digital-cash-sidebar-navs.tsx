...
import NavLink from "@/pattern/common/atoms/custom-nav-link";
import {
...
const DigitalCashNavigation = () => {
   ...
   *
   * @description
   * Determines when a Nav link is currently on Spotlight
   * This can only be true if app tour is ongoing and would be false thereafter
   */
