...
import { FundRedemptionIcon } from "@emtech/icons";
...
const FundRedemptionTab = () => {
  ...
  // API query for Request Redemption
  const {
    data: requestTable,
    isLoading,
    isError,
...
export default FundRedemptionTab;
