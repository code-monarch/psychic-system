...
const rowData: RowData[] = [
  {
    ...
    approver: 'Jean Baden Dubois',
    walletAddress: '0865FGHD7439',
  },
  {
    id: '12345ABCDF',
    organization: 'Sogebank',
...
export default function WalletsTable() {
  return <DynamicTable columnData={columnData} columnStyle={columnAlignment} rowData={rowData} />;
}
